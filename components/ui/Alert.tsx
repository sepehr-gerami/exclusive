...
export default function Alert({ show, onClose,title,sub, duration = 4000 }: AlertProps) {
      ...
      >
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:"10px" }}>
          <div style={{
            ...
            background:"rgba(43,152,117,0.13)", border:"1px solid rgba(43,152,117,0.22)",
            display:"flex", alignItems:"center", justifyContent:"center", color:"#2b9875",
          }}>
        ...
        <div style={{ position:"absolute", bottom:0, left:"14px", right:"14px", height:"2px", background:"rgba(255,255,255,0.06)", overflow:"hidden" }}>
          <div style={{ height:"100%", background:"linear-gradient(90deg,#2b9875,#34d39a)", animation:`shrink ${duration}ms linear forwards` }}/>
        </div>
      </div>
    </>
  )
